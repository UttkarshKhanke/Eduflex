...
function Dashboard() {
  ...
  return (
    <div className="p-8 bg-gray-50 min-h-screen">
      ...
      {/* Loading & Error */}
      {loading ? (
        <div className="text-center text-gray-600 text-lg">Loading stats...</div>
      ) : error ? (
            ...
            {role === "instructor" ? (
              <>
                ...
                <div className="flex flex-wrap gap-4">
                  ...
                  <button
                    ...
                    className="bg-gradient-to-r from-amber-500 to-orange-400 text-white px-6 py-3 rounded-lg font-medium hover:opacity-90 transition"
                  >
                    Manage Quizzes
                  </button>
                </div>
              ...
              <>
                ...
                <div className="flex flex-wrap gap-4">
                  <button
                    onClick={() => handleNavigation("/courses")}
                    className="bg-gradient-to-r from-indigo-600 to-blue-500 text-white px-6 py-3 rounded-lg font-medium hover:opacity-90 transition"
                  >
                    Go to Courses
                  </button>
                  <button
                    onClick={() => handleNavigation("/analytics")}
                    className="bg-gradient-to-r from-green-500 to-emerald-400 text-white px-6 py-3 rounded-lg font-medium hover:opacity-90 transition"
                  >
                    View Analytics
                  </button>
                  <button
                    onClick={() => handleNavigation("/quiz")}
                    className="bg-gradient-to-r from-blue-500 to-blue-400 text-white px-6 py-3 rounded-lg font-medium hover:opacity-90 transition"
                  >
                    Go to Quiz
                  </button>
                </div>
